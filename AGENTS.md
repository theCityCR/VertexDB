...
| `src/execution/` | `QueryExecutor` façade; `ExecutionContext`; `SelectEngine` (+ scan/join), `DmlEngine`, `CatalogEngine`, subquery (+ bind/cte TUs), txn, recovery; helpers include `foreign_key_eval` |
