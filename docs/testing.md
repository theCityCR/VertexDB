...
| `persistence_behavior_tests.cpp` | Page store, snapshot v4, page-image/physical/torn WAL, durable WAL append/`reset` (flush+fsync) |
...
The current suite contains 287 discovered GoogleTest cases across the files above.
