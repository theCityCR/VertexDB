...
| `nested_recursive_tests.cpp` | `WITH RECURSIVE` (walk, multiple independent recursive CTEs, documented refusals incl. mutual recursion, iteration/row caps) |
...
The current suite contains 272 discovered GoogleTest cases across the files above.
