...
The current suite contains 94 discovered GoogleTest cases across parser, storage, index, execution,
nested SQL rewrite/`EXPLAIN`, desired-behavior coverage, deep-feature, and regression tests (two
