...
| `planner_mutation_tests.cpp` | Indexed UPDATE/DELETE `WHERE` (HashEq/HashIn/range/intersect/union/prefix LIKE/trigram/composite HashEq/nested Intersect∪Union/collect-then-mutate); `EXPLAIN UPDATE`/`DELETE`/`INSERT` |
