...
inline constexpr std::uint32_t kVersionV6 = 6;
inline constexpr std::uint32_t kVersionV7 = 7;
inline constexpr std::uint32_t kVersionV8 = 8; // composite indexes + table-level unique constraints
inline constexpr std::uint32_t kVersion = 9;   // multi-column FOREIGN KEY column lists
inline constexpr std::uint8_t kNullValueType = 255;
inline constexpr std::uint8_t kCompositeValueType = 254;
